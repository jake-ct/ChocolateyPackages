...
$url        = 'https://teach.mapnwea.org/contents/partner/Setup%20Lockdown%20Browser.exe' # download url, HTTPS preferred
...
$packageArgs = @{
 ...
 #file         = $fileLocation
  ...
  softwareName  = 'NWEA Secure Testing Browser*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'B01673E8FCB1497A3B08D55D22C435CC6C7409A2DB284DC8821D50FA783E4F39'
  ...
  silentArgs   = '/v/qn /s'   # InstallShield with MSI
